...
public class ADJUNTA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ADJUNTA DE MATRICES");
    ...
    private void CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalcularActionPerformed
        ...
        if (NFILAS_A==NCOLUMNAS_A) {
            OrganizarTabla();
            double [][] resultado = operaciones.AdjuntaMatriz(matrizA);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADJUNTA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
